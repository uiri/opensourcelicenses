...
\raggedright
\bibitem{apache1} The Apache Software Foundation. Apache License, Version 1.0 [Online]. Available: \url{https://www.apache.org/licenses/LICENSE-1.0}

\bibitem{apache11} The Apache Software Foundation. Apache License, Version 1.1 [Online]. Available: \url{https://www.apache.org/licenses/LICENSE-1.1}

\bibitem{apache2} The Apache Software Foundation. Apache License, Version 2.0 [Online]. Available: \url{https://www.apache.org/licenses/LICENSE-2.0}

\bibitem{license-stats} Black Duck. Top 20 Open Source Licenses [Online]. Available: \url{https://www.blackducksoftware.com/resources/data/top-20-open-source-licenses}.

\bibitem{boost} Boost C++ Libraries. Boost Software License [Online]. Available: \url{http://www.boost.org/users/license.html}

\bibitem{nolicense} ChooseALicense.com. No License [Online]. Available: \url{http://choosealicense.com/no-license/}

\bibitem{billyg} DigiBarn Computer Museum. Bill Gates' Open Letter To Hobbyists [Online]. Available: \url{http://www.digibarn.com/collections/newsletters/homebrew/V2_01/gatesletter.html}

\bibitem{epl} Eclipse. Eclipse Public License (EPL) Frequently Asked Questions [Online]. Available: \url{http://www.eclipse.org/legal/eplfaq.php#CPLEPL}

\bibitem{originalbsd} Free Software Directory. License:BSD 4Clause [Online]. Available: \url{directory.fsf.org/wiki/License:BSD_4Clause}

\bibitem{simplifiedbsd} Free Software Directory. License:FreeBSD [Online]. Available: \url{http://directory.fsf.org/wiki?title=License:FreeBSD}

\bibitem{x11} Free Software Directory. License:X11 [Online]. Available: \url{http://directory.fsf.org/wiki/License:X11}

\bibitem{fsfhistory} GNU Operating System. About the GNU Projec [Online]. Available: \url{https://www.gnu.org/gnu/thegnuproject.html}

\bibitem{netbsd} GNU Operating System. BSD License Problem [Online]. Available: \url{https://www.gnu.org/philosophy/bsd.html}

\bibitem{gpl2} GNU Operating System. GNU General Public License, version 2 [Online]. Available: \url{https://www.gnu.org/licenses/gpl-2.0.html}.

\bibitem{licenselist} GNU Operating System. Various Licenses and Comments About Them [Online]. Available: \url{https://www.gnu.org/licenses/license-list.html}

\bibitem{copyleft} GNU Operating System. What is Copyleft [Online]? Available: \url{https://www.gnu.org/copyleft/}.

\bibitem{fourfreedoms} GNU Operating System. What is Free Software [Online]? Available: \url{https://www.gnu.org/philosophy/free-sw.html}

\bibitem{gpl3} GNU Operating System. A Quick Guide to GPLv3 [Online]. Available: \url{https://www.gnu.org/licenses/quick-guide-gplv3.html}.

\bibitem{lgpl} GNU Operating System. GNU Lesser General Public License [Online]. Available: \url{https://www.gnu.org/licenses/lgpl.html}.

\bibitem{agpl} GNU Operating System. Why the Affero GPL [Online]. Available: \url{https://gnu.org/licenses/why-affero-gpl.html}.

\bibitem{mpl} Mozilla. MPL 2.0 FAQ [Online]. Available: \url{https://www.mozilla.org/MPL/2.0/FAQ.html}

\bibitem{openbsd} OpenBSD. OpenBSD Copyright Policy [Online]. Available: \url{http://www.openbsd.org/policy.html}

\bibitem{academic} Open Source Initiative. Academic Free License 3.0 [Online]. Available: \url{http://opensource.org/licenses/AFL-3.0}

\bibitem{attrassur} Open Source Initiative. Attribution Assurance License [Online]. Available: \url{http://opensource.org/licenses/AAL}

\bibitem{cpl} Open Source Initiative. Common Public License Version 1.0 [Online]. Available: \url{http://opensource.org/licenses/CPL-1.0}

\bibitem{education} Open Source Initiative. Education Community License, Version 2.0 [Online]. Available: \url{http://opensource.org/licenses/ECL-2.0}

\bibitem{fair} Open Source Initiative. Fair License (Fair) [Online]. Available: \url{http://opensource.org/licenses/Fair}

\bibitem{permissive} Open Source Initiative. Frequently Answered Questions [Online]. Available: \url{http://opensource.org/faq}

\bibitem{opensourcehistory} Open Source Initiative. History of the OSI [Online]. Available: \url{http://opensource.org/history}

\bibitem{mit} Open Source Initiative. The MIT License (MIT) [Online]. Available: \url{http://opensource.org/licenses/MIT}

\bibitem{opensourcedefinition} Open Source Initiative. The Open Source Definition [Online]. Available: \url{http://opensource.org/definition}

\bibitem{sqlite} SQLite. SQLite Copyright [Online]. Available: \url{https://www.sqlite.org/copyright.html}

\bibitem{copyright} Teaching Copyright. Copyright Frequently Asked Questions [Online]. Available: \url{http://www.teachingcopyright.org/handout/copyright-faq}

\bibitem{wtfpl} WTPF. WTFPL – Do What the Fuck You Want to Public License. Frequently Asked Questions [Online]. Available: \url{http://www.wtfpl.net/faq/}
